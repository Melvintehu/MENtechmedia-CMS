    ...
    <div v-show="loaded">
        ...
        <div v-if="object !== null && object !== undefined">
            ...
            <div  v-for="(attribute, attributeName) in object.fields" class="col-lg-12 space-inside-xs reset-padding">
                ...
                <component :updateMode="true" :model_id="id" :attributeName="attributeName" :attribute="attribute" :type="type"  :value="innerValue" :identifier="identifier" :is="'crud-' + attribute.type"></component>           
